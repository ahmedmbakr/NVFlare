...
This repository implements a federated learning solution for parking space detection using NVIDIA FLARE (NVFlare) framework.
...
The system uses a SSDNet16/ResNet50 model architectures for detecting parking spaces across multiple sites while preserving data privacy.
However, it can be adapted to other object detection models as needed.
...
- Runs two clients in simulation mode
